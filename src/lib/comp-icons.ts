...
const iconMap: Record<string, CompIcon> = {
  ...
  "tata-innovista-2026": { emoji: "🏭", short: "Tata", label: "Tata Group" },
  ...
  "bajaj-finserv-olympiad-2026": { emoji: "💰", short: "BJFS", label: "Bajaj Finserv" },
  "deloitte-ironman-2026": { emoji: "📊", short: "Del", label: "Deloitte" },
  ...
  "fms-case-wars-2026": { emoji: "⚔️", short: "FMS", label: "FMS Delhi" },
  "mdi-national-case-2026": { emoji: "🏫", short: "MDI", label: "MDI Gurgaon" },
  "iim-delhi-intra-2026": { emoji: "🎯", short: "IIMD", label: "IIM Delhi" },
  "colgate-transcend-2026": { emoji: "🦷", short: "Col", label: "Colgate" },
  "pg-cto-challenge-2026": { emoji: "🧴", short: "P&G", label: "Procter & Gamble" },
  "yes-bank-transformation-2026": { emoji: "🏦", short: "YES", label: "YES Bank" },
  "nivea-marathon-2026": { emoji: "✨", short: "NIV", label: "NIVEA" },
  "rb-mavericks-2026": { emoji: "🚀", short: "RB", label: "Reckitt Mavericks" },
};
