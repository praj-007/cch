...
const iconMap: Record<string, CompIcon> = {
  ...
  "trilytics-26-2026": { emoji: "📊", short: "IIC", label: "IIM Calcutta Trilytics" },
  "iimb-insightforge-2026": { emoji: "🔬", short: "IIB", label: "IIM Bangalore" },
  "learnous-case-challenge-2026": { emoji: "📚", short: "LRN", label: "Learnous" },
